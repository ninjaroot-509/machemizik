			...
			<ImageBackground style={styles.container} source={{ uri: song?.detail?.img }} blurRadius={10} resizeMode="cover">
				...
				<Header
					options={{
						...
						right: {
							children: <Icon name={isFav ? 'heart' : 'hearto'} family="AntDesign" color={isFav ? '#f24160' : '#FFF'} />,
							onPress: handleFav,
						},
					}}
				/>
				<View style={styles.frame}>
					...
					<View style={styles.actionsContainer}>
						<TouchableOpacity onPress={handlePrev}>
							<Icon name="skip-back" color="#ffffff" />
						</TouchableOpacity>
						<TouchableOpacity onPress={handlePlayAndPause}>
							<View style={[styles.playAndPauseBtn, !song?.soundObj?.isPlaying && { paddingLeft: 4 }]}>
